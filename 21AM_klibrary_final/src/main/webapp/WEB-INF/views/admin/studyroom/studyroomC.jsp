...
<div id="ad_right">
	<div id="contHeader">열람실 관리 > 열람실 C</div>
    ...
    $(function(){
        ...
        // ul li 배경화면 
        $(".navOptions").eq(3).children().eq(3).css({ "font-size": "20px", "fontWeight": "bold", "backgroundColor": "#7DA5E1" });
    })
    
    $(function(){
   			$.ajax({
   			url : "${path}/admin/studyroom/selUsingListC",
    ...
    const fn_paging= function(cPage){
    	$.ajax({
   			url : "${path}/admin/studyroom/selUsingListC?cPage="+cPage,
   			success : function(data){
   				$("#useMemTabWrap").html(data);
   			}
    	})
