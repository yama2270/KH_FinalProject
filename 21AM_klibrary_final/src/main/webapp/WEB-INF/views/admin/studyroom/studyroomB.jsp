...
<jsp:include page="/WEB-INF/views/admin/common/header.jsp">
	<jsp:param name="title" value="열람실B" />
</jsp:include>

<div id="ad_right">
	<div id="contHeader">열람실 관리 > 열람실 B</div>
    ...
    $(function(){
        ...
        // ul li 배경화면 
        $(".navOptions").eq(3).children().eq(2).css({ "font-size": "20px", "fontWeight": "bold", "backgroundColor": "#7DA5E1" });
    })
    
    $(function(){
   			$.ajax({
   			url : "${path}/admin/studyroom/selUsingListB",
    ...
    const fn_paging= function(cPage){
    	$.ajax({
   			url : "${path}/admin/studyroom/selUsingListB?cPage="+cPage,
   			success : function(data){
   				$("#useMemTabWrap").html(data);
   			}
    	})
