...
<body id="ad_body">
    <header id="ad_header">
            <div id="header_title"><img src='${path}/resources/images/logo.png' width="200px" height="100px" style="border-radius:70%" onclick="javascript:location.assign('${path}')"></div>
