...
public class AdminBookController {
	...
	//국립중앙도서관 open api 
	@RequestMapping(value="/admin/book/searchBook.do",produces="application/xml;charset=UTF-8")
	@ResponseBody
	public Object searchBook(@RequestParam Map param) {
		Object obj = service.searchBook(param);
		System.out.println(obj);
		/* return service.searchBook(param).getBody(); */
		return obj;
	}
